...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=12, block_config=(16, 16, 16), compression=0.5,
                 ...
                 num_classes=34, small_inputs=True, efficient=False):
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv1d(8, 64, kernel_size=15, stride=2, padding=7, bias=False)),
        ]))
        self.features.add_module('norm0', nn.BatchNorm1d(64))
        ...
        # Linear layer
        self.classifier = nn.Linear(num_features*16, num_classes)
    ...
    def forward(self, x):
        ...
        out = F.avg_pool1d(out, kernel_size=self.avgpool_size).view(features.size(0), -1)
