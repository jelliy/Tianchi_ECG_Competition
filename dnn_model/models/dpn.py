...
def dpn68(num_classes=34, pretrained=None):
    model = DPN(
...
class InputBlock(nn.Module):
    def __init__(self, num_init_features, kernel_size=7,
        ...
        self.conv = nn.Conv1d(
            8, num_init_features, kernel_size=kernel_size, stride=2, padding=padding, bias=False)
...
class DPN(nn.Module):
    def __init__(self, small=False, num_init_features=64, k_r=96, groups=32,
                 ...
                 num_classes=34, test_time_pool=False):
