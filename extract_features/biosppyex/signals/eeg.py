...
def eeg(signal=None, sampling_rate=1000., labels=None, show=True):
    ...
    # plot
    if show:
        plot(alpha_high, alpha_low, beta, filtered, gamma, labels, plf, plf_pairs, signal, theta, ts, ts_feat)
...
def plot(alpha_high, alpha_low, beta, filtered, gamma, labels, plf, plf_pairs, signal, theta, ts, ts_feat):
